    ...
    case '/register':
      return [
        ...
        body('subscribers.*.holder')
          ...
          .isString()
          .withMessage('Subscribers.Holder should be String'),
        body('subscribers.*.email')
          .exists().withMessage('Subscribers.Email is required')
          .isString()
          .withMessage('Subscribers.Email should be String'),
        body('password')
          .exists().withMessage('Password is required')
          .isLength({ min: 8 })
          .withMessage('Password should be 8 characters long')
        ...
        body('nic')
          ...
          .withMessage('NIC should be between 10 to 12 characters long'),
        body('contactNumber')
        ...
        body('supplier').exists().withMessage('Supplier is required')
          .isString()
          .withMessage('Supplier should be String'),
        body('tariff').exists().withMessage('Tariff is required')
          .isString()
          .withMessage('Tariff should be String'),
        body('accountNumber').exists().withMessage('Account number is required')
          .isNumeric()
          .withMessage('Account number should be Number')
          .isLength({ min: 10, max: 10 })
          .withMessage('Account number should be 10 characters long'),
    ...
    case '/payloads':
      return [
        body('currentRound')
          ...
          .isNumeric()
          .withMessage('Current round should be Number'),
        body('current')
          .exists().withMessage('Current is required')
          .isNumeric()
          .withMessage('Current should be Number'),
        body('voltage')
          .exists().withMessage('Voltage is required')
          .isNumeric()
          .withMessage('Voltage should be Number'),
        body('power')
          .exists().withMessage('Power is required')
          .isNumeric()
          .withMessage('Power should be Number'),
        body('frequency')
          .exists().withMessage('Frequency is required')
          .isNumeric()
          .withMessage('Frequency should be Number'),
        body('totalPower')
          .exists().withMessage('Total power is required')
          .isNumeric()
          .withMessage('Total power should be Number'),
        body('importPower')
          .exists().withMessage('Import power is required')
          .isNumeric()
          .withMessage('Import power should be Number'),
        body('exportPower')
          .exists().withMessage('Export power is required')
          .isNumeric()
          .withMessage('Export power should be Number'),
        body('powerFactor')
          .exists().withMessage('Power factor is required')
          .isNumeric()
          .withMessage('Power factor should be Number'),
        body('rssi')
          .exists().withMessage('RSSI is required')
          .isNumeric()
          .withMessage('RSSI should be Number'),
      ];
    case '/errors':
      return [
        body('error')
        ...
        body('wifiFailCount')
          ...
          .isNumeric()
          .withMessage('Wifi fail count should be Number'),
        body('httpFailCount')
          .exists().withMessage('Http fail count is required')
          .isNumeric()
          .withMessage('Http fail count should be Number'),
      ];
    default:
      return [];
  }
    ...
    case '/reports/:_id':
      return [
        param('_id')
          ...
          .isMongoId()
          .withMessage('Invoice ID should be Mongo ID'),
      ];
    default:
      return [];
  }
